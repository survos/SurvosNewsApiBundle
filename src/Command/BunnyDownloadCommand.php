...
#[AsCommand('news-api:download', 'download remote news-api files')]
final class NewsApiDownloadCommand extends InvokableServiceCommand
{
    use RunsCommands;
    use RunsProcesses;
...
bin/console -vvv news-api:download data/composer.json
...
//            dump(realPath: $downloadPath, filename: $shortDownloadFilename);
            $ret = $this->news-apiService->downloadFile($remoteShortName, $remotePath, $zoneName);
